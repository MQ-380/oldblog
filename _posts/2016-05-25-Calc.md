...
$$
考虑直线Ax+By+C = 0和点(x_0,y_0),他们之间的距离可以得到为 \frac{|Ax_0+By_0+c|}{\sqrt{A^2+B^2}}
$$
因为这里所有的点都在这条直线的一侧，所以可以直接用之前就在输入的时候就预算好的x，y的和值就可以得到距离和。
$$
对于以(x_1,y1)和(x_2,y_2)构成的直线，将二点式化成一般式之后得(y_2-y_1)x+(x_1-x2)y+(x_2y_1-x_1y_2) = 0
$$
